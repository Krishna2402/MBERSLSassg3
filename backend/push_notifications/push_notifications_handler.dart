...
class _PushNotificationsHandlerState extends State<PushNotificationsHandler> {
  ...
  Widget build(BuildContext context) => _loading
      ? Container(
          ...
          child: Image.asset(
            'assets/images/WhatsApp_Image_2024-09-01_at_18.43.19.jpeg',
            fit: BoxFit.contain,
          ),
        )
      : widget.child;
...
final parametersBuilderMap =
  ...
  'profile_Main': ParameterData.none(),
  'profile_ChangePassword': ParameterData.none(),
  'authentication_1': ParameterData.none(),
  'profile_Edit': ParameterData.none(),
  'profile_Create': ParameterData.none(),
  'HomePage': ParameterData.none(),
  'ContactInfo': ParameterData.none(),
  'IncidentLogin': ParameterData.none(),
  'UserList': ParameterData.none(),
  'AdminPage': ParameterData.none(),
  'authgate': ParameterData.none(),
  'AlertRequest': ParameterData.none(),
