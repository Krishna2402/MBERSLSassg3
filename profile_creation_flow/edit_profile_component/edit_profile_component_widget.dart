...
class _EditProfileComponentWidgetState
  ...
  void initState() {
    ...
    _model.matrixNoTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.matrixNo, ''));
    _model.matrixNoFocusNode ??= FocusNode();
    ...
    _model.inasisTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.inasis, ''));
    _model.inasisFocusNode ??= FocusNode();
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => TextFormField(
                  controller: _model.matrixNoTextController,
                  focusNode: _model.matrixNoFocusNode,
                  autofillHints: const [AutofillHints.name],
                  textCapitalization: TextCapitalization.words,
                  obscureText: false,
                  decoration: InputDecoration(
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primary,
                  validator: _model.matrixNoTextControllerValidator
                      .asValidator(context),
                ),
              ),
            ),
            Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => TextFormField(
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primary,
                  validator:
                      _model.schoolTextControllerValidator.asValidator(context),
                ),
              ),
            ),
            Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => TextFormField(
                  controller: _model.inasisTextController,
                  focusNode: _model.inasisFocusNode,
                  autofillHints: const [AutofillHints.name],
                  textCapitalization: TextCapitalization.words,
                  obscureText: false,
                  decoration: InputDecoration(
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primary,
                  validator:
                      _model.inasisTextControllerValidator.asValidator(context),
                ),
              ),
            ),
            Align(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => FlutterFlowDropDown<String>(
                    ...
                    options: List<String>.from(
                        ['student', 'security unit', 'principal']),
                    optionLabels: const ['student', 'unit keselamatan', 'principal'],
                    onChanged: (val) =>
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    await currentUserReference!.update(createUsersRecordData(
                      ...
                      matrixNo: _model.matrixNoTextController.text,
                      inasis: _model.inasisTextController.text,
                      bod: _model.datePicked,
