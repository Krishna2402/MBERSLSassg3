...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'IncidentLogin',
          path: '/incidentLogin',
          builder: (context, params) => const IncidentLoginWidget(),
        ),
        FFRoute(
          name: 'UserList',
          path: '/userList',
        ...
        FFRoute(
          name: 'AlertRequest',
          path: '/alertRequest',
          builder: (context, params) => const AlertRequestWidget(),
        ),
        FFRoute(
          name: 'VideoCall',
          path: '/videoCall',
        ...
        FFRoute(
          ...
          builder: (context, params) => LocationWidget(
            ref: params.getParam(
              ...
              isList: false,
              collectionNamePath: ['alert_request'],
            ),
          ),
        )
